      ...
      <footer className="px-4   bg-[#F6FBFF]  ">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            ...
            >
              <span className="text-2xl font-semibold text-left mb-2">
                UP BUSINESS
              </span>
              <p className="max-w-sm ml-2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Vulputate a, ultricies sit nunc purus vel cras pellentesque.
              </p>

            </a>
            <div className="flex justify-start space-x-3 mt-3 ml-2">
          ...
          <div className="grid grid-cols-2 text-sm  gap-y-[1rem] lg:w-2/4 sm:grid-cols-3">
